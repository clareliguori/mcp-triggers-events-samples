...
- [x] 2. CDK infrastructure — base stacks and DNS
  - [x] 2.1 Create CDK app entry point and shared infrastructure
...
- [x] 10. Subscription Manager
  ...
  - [x] 10.2 Implement subscription refresh logic
